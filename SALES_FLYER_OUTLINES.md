# Sales Flyer Outlines for p0stmaster

AI-ready outlines for generating professional marketing flyers. Feed any of these into an AI image generator (Midjourney, DALL-E, Canva AI, Adobe Firefly) or an AI copywriter (ChatGPT, Claude, Gemini) to produce polished sales materials.

---

## How to use these outlines

1. **Pick a flyer** that matches your target audience
2. **Copy the prompt block** into your preferred AI tool
3. **Customise** the bracketed `[placeholders]` with your specifics
4. **Generate** the visual or copy, then refine

Each outline includes:
- A headline and tagline
- Key selling points
- Visual direction for designers or AI image generators
...
Include:
- A punchy headline (under 10 words)
- A tagline (one sentence)
...
## Flyer 2: The Freelancer Pitch

**Target audience:** Freelance social media managers and content creators
...
- Laptop on a coffee-shop table showing p0stmaster interface
- Floating platform icons (IG, FB, LinkedIn, X, TikTok, YT, Pinterest) around the screen
...
```
Design a clean, modern product flyer for "p0stmaster", a free social media management app aimed at freelancers.
...
- Bottom: Green CTA button "Try It Free" with GitHub link
- Badge: "No account needed • No monthly fees • Open source"

Mood: Empowering, accessible, "this makes my life easier"
Dimensions: Instagram story (1080x1920) and standard letter (8.5x11)
```
...
Tone: Friendly, relatable, energising. Like a smart friend recommending their favourite tool.

Include:
- A headline that speaks to the freelancer's pain of juggling tools
...
## Flyer 3: The Enterprise / In-House Team Pitch

**Target audience:** In-house marketing teams at mid-size companies
...
```
Design a professional enterprise flyer for "p0stmaster", an open-source social media publishing tool for in-house marketing teams.
...
Dimensions: 8.5 x 11 inches, print-ready with bleed
```
...
Include:
- A headline that leads with governance and control (not AI or flashy features)
- 6 bullet points: 3 about governance/security, 3 about capability
- A brief "How It Works" section (4 steps)
...
## Flyer 4: The Feature Showcase

**Target audience:** General audience, product-aware prospects
...
**Visual direction:**
- Bold, feature-dense design — more "product spec sheet" than "marketing poster"
...
```
Design a bold feature-showcase flyer for "p0stmaster", a free open-source social media management app.
...
## Flyer 5: The Quick Social Ad

**Target audience:** Social media ad (Instagram/Facebook/LinkedIn ad format)
...
**Visual direction:**
- Square (1080×1080) or story (1080×1920) format
- Bold text on dark gradient background
- App interface peeking from the bottom or side
- Prominent "FREE" badge
- Platform icons as a subtle row

**Call to action:** Download at github.com/AkitaEngineering/p0stmaster
...
```
Design a social media ad (1080x1080 square) for "p0stmaster", a free open-source social media management app.

Style: Bold and minimal. Dark gradient background (black to deep indigo #312E81). White and indigo text.

Layout:
- Top 40%: Bold headline "Publish to 7 Platforms. One Click. $0." in large white text
- Middle: Compact app UI mockup (showing the preview panel with platform cards) floating with a soft shadow
- Bottom: Row of 7 platform icons with a pulsing glow
- Corner badge: "FREE & OPEN SOURCE" in a rounded pill shape
- Bottom CTA: "Download Now" with github URL in small text

Typography: Modern geometric sans-serif (Inter, Satoshi, or similar)
Mood: Punchy, confident, scroll-stopping
```

### AI Copywriter Prompt (for ad copy)
...
Tone: Direct, benefit-focused, slightly provocative about SaaS pricing
...
## Bonus: Print/Handout Quick-Reference Card

**Format:** Business card or postcard size
...
Built by Akita Engineering
```

### AI Image Prompt for Quick-Reference Card
